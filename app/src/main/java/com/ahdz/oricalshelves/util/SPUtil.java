...
public class SPUtil {
    ...
    public static void setUserid(String session) {
        SPUtil.putString(MyApplication.getInstance(),SPUtil.SP_FILE_NAME,"USER_ID",session);
    }
    public static String getUserid() {
        return ""+ SPUtil.getString(MyApplication.getInstance(), "USER_ID", "");
    }

    public static void setDeviceId(String session) {
        SPUtil.putString(MyApplication.getInstance(),SPUtil.SP_FILE_NAME,"DEVICE",session);
    }

    public static String getDeviceId() {
        return ""+ SPUtil.getString(MyApplication.getInstance(), "DEVICE", "");
    }
