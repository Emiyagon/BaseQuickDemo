...
/**
 * Created by syy on 2016/7/6.
 * 实现回弹效果
 */
public class MyScrollViewTang extends ScrollView {
    ...
    public MyScrollViewTang(Context context) {
        super(context);
    }

    public MyScrollViewTang(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
